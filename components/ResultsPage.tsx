      ...
      <Section title="Match History & Statistics">
        <div className="space-y-8">
          ...
          <div className="bg-[#010A13]/70 p-6 border border-[#CDA434]/30">
            <h3 className="text-3xl font-bold text-[#CDA434] mb-6 text-center">Aggregated Summary</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mt-4">
              <div className="text-center">
                <p className="text-xl font-bold text-white">{analysis.aggregatedSummary.avgKills.toFixed(1)}</p>
                <p className="text-sm text-gray-400">Avg Kills</p>
              </div>
              <div className="text-center">
                <p className="text-xl font-bold text-white">{analysis.aggregatedSummary.avgDeaths.toFixed(1)}</p>
                <p className="text-sm text-gray-400">Avg Deaths</p>
              </div>
              <div className="text-center">
                <p className="text-xl font-bold text-white">{analysis.aggregatedSummary.avgAssists.toFixed(1)}</p>
                <p className="text-sm text-gray-400">Avg Assists</p>
              </div>
              <div className="text-center">
                <p className="text-xl font-bold text-white">{analysis.aggregatedSummary.avgCS.toFixed(1)}</p>
                <p className="text-sm text-gray-400">Avg CS</p>
              </div>
              <div className="text-center">
                <p className="text-xl font-bold text-white">{analysis.aggregatedSummary.avgGold.toFixed(0)}</p>
                <p className="text-sm text-gray-400">Avg Gold</p>
              </div>
              <div className="text-center">
                <p className="text-xl font-bold text-white">{analysis.aggregatedSummary.avgVisionScore.toFixed(1)}</p>
            ...
            <table className="w-full border-collapse bg-[#010A13]/70">
              <thead>
                <tr className="border-b-2 border-[#CDA434]/50">
                  ...
                  <th className="px-4 py-3 text-center text-[#CDA434] font-bold">Vision</th>
                  <th className="px-4 py-3 text-center text-[#CDA434] font-bold">Position</th>
                </tr>
              </thead>
              <tbody>
                {analysis.matchData.map((match) => {
